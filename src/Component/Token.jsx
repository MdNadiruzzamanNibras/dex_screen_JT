   ...
   console.log(data);
    return (
        <div  style={{backgroundImage: `url(${background})`, height:"100vh", width:"85vw" }}>
                ...
                <input style={{borderRadius:"50px", marginRight:"60vw"}} className="w-96 input input-bordered input-dark mt-20 h-12   text-center text-lg" type="text"  id="" placeholder='serach'
      value={token} 
      ...
      onKeyPress={handlesearch} 
        ...
        <div className="mt-9">
          <h1 className="text-4xl font-bold ml-4 text-white">Token Search Results</h1>
          { data?.pairs?.map( (dex)=>
